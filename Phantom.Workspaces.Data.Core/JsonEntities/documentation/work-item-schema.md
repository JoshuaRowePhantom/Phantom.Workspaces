...
A platform-agnostic work item entity representing an issue or bug on any hosting platform.
...
This is an abstract base type. Tools should create platform-specific subtypes (e.g. `git-work-item`) rather than raw `work-item` entities.
...
- [git-work-item.json](git-work-item-schema.md) - Git-layer work item schema
