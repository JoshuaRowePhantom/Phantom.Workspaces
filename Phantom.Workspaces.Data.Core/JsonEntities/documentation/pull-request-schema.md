...
This is an abstract base type. Tools should create platform-specific subtypes (e.g. `git-pull-request`) rather than raw `pull-request` entities.
...
- [git-pull-request.json](git-pull-request-schema.md) - Git-layer pull request schema
