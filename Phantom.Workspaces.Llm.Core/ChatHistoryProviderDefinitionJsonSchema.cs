...
public static class ChatHistoryProviderDefinitionJsonSchema
{
    private const string ResourceName = "Phantom.Workspaces.Llm.Core.JsonSchemas.chat-history-provider.json";
