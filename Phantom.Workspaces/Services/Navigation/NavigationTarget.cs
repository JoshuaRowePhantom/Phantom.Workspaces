...
/// Either <see cref="Path"/> identifies an existing (or open-but-unselected) tab, or — for the
...
/// </summary>
/// <remarks>
/// Constructed via object initializers so call sites cannot separate pane and tab identity.
/// </remarks>
public sealed record NavigationTarget
{
    public UiPath? Path { get; init; }

    /// <summary>The entity to open when <see cref="Path"/> is <see langword="null"/> (brain fallback).</summary>
