...
public sealed class SubAgentsContainerViewModelTests
{
    ...
    public async Task ShowSubAgent_MultipleSlots_OnlyCorrectSlotSelected()
    {
        ...
        await using var viewModel1 = new AgentViewModel(chat1, "Agent One", "", loggerFactory, TaskScheduler.Default);
        await using var viewModel2 = new AgentViewModel(chat2, "Agent Two", "", loggerFactory, TaskScheduler.Default);
